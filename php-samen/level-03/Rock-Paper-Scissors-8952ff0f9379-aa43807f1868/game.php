...
<body>
    ...
    <form action="" method="post">
        <input type="radio" name="player_choice" value="steen"> Steen<br>
        <input type="radio" name="player_choice" value="papier"> Papier<br>
        <input type="radio" name="player_choice" value="schaar"> Schaar<br>
